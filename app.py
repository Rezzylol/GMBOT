...
OPENAI_SYSTEM_PROMPT = (
    ...
    "If required, you can use bold, italic, underlined, strikethrough, and spoiler text, as well as inline links and pre-formatted code in your your response, using Telegram MarkdownV2. In this case, use the following syntax in your response:\n"
    "*bold \*text*\n"
    "_italic \*text_\n"
    "__underline__\n"
    "~strikethrough~\n"
